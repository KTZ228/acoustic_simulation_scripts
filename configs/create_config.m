...
config = struct();
data_path = '/home/affneu/kenvdzee/Documents/focal_steering_tables/extracted_files/';
config.gen.charac_path = strcat(data_path, 'Axial profiles');
...
config.gen.prestus_virt_path = strcat(data_path, 'PRESTUS virtual parameters');
...
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-250-001~TPO-203-035.xlsx'));

split_combo = string(strcat(field_name_tran_2, '_', field_name_ds_1)); 
config.combos.(split_combo).tran_serial = field_name_tran_2;
config.combos.(split_combo).ds_serial = field_name_ds_1; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-250-009~TPO-203-035.xlsx'));

split_combo = string(strcat(field_name_tran_3, '_', field_name_ds_1)); 
config.combos.(split_combo).tran_serial = field_name_tran_3;
config.combos.(split_combo).ds_serial = field_name_ds_1; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-250-014~TPO-203-035.xlsx'));
...
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-250-026~TPO-203-035.xlsx'));

split_combo = string(strcat(field_name_tran_5, '_', field_name_ds_1)); 
config.combos.(split_combo).tran_serial = field_name_tran_5;
config.combos.(split_combo).ds_serial = field_name_ds_1; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-500-006~TPO-203-035.xlsx'));

split_combo = string(strcat(field_name_tran_6, '_', field_name_ds_1)); 
config.combos.(split_combo).tran_serial = field_name_tran_6;
config.combos.(split_combo).ds_serial = field_name_ds_1; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-500-026~TPO-203-035.xlsx'));
...
config.combos.(split_combo).tran_serial = field_name_tran_2;
config.combos.(split_combo).ds_serial = field_name_ds_2; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name, 'CTX-250-009~TPO-105-010.xlsx'));

split_combo = string(strcat(field_name_tran_3, '_', field_name_ds_2)); 
config.combos.(split_combo).tran_serial = field_name_tran_3;
config.combos.(split_combo).ds_serial = field_name_ds_2; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-250-014~TPO-105-010.xlsx'));

split_combo = string(strcat(field_name_tran_4, '_', field_name_ds_2)); 
config.combos.(split_combo).tran_serial = field_name_tran_4;
config.combos.(split_combo).ds_serial = field_name_ds_2; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-250-026~TPO-105-010.xlsx'));

split_combo = string(strcat(field_name_tran_5, '_', field_name_ds_2)); 
config.combos.(split_combo).tran_serial = field_name_tran_5;
config.combos.(split_combo).ds_serial = field_name_ds_2; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-500-006~TPO-105-010.xlsx'));

split_combo = string(strcat(field_name_tran_6, '_', field_name_ds_2)); 
config.combos.(split_combo).tran_serial = field_name_tran_6;
config.combos.(split_combo).ds_serial = field_name_ds_2; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'CTX-500-026~TPO-105-010.xlsx'));
...
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15287_01001~IGT_128_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_8, '_', field_name_ds_3)); 
config.combos.(split_combo).tran_serial = field_name_tran_8;
config.combos.(split_combo).ds_serial = field_name_ds_3; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15287_01002~IGT_128_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_9, '_', field_name_ds_3)); 
config.combos.(split_combo).tran_serial = field_name_tran_9;
config.combos.(split_combo).ds_serial = field_name_ds_3; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15473_01001~IGT_128_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_10, '_', field_name_ds_3)); 
config.combos.(split_combo).tran_serial = field_name_tran_10;
config.combos.(split_combo).ds_serial = field_name_ds_3; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15473_01002~IGT_128_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_7, '_', field_name_ds_4)); 
config.combos.(split_combo).tran_serial = field_name_tran_7;
config.combos.(split_combo).ds_serial = field_name_ds_4; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15287_01001~IGT_32_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_8, '_', field_name_ds_4)); 
config.combos.(split_combo).tran_serial = field_name_tran_8;
config.combos.(split_combo).ds_serial = field_name_ds_4; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15287_01002~IGT_32_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_9, '_', field_name_ds_4)); 
config.combos.(split_combo).tran_serial = field_name_tran_9;
config.combos.(split_combo).ds_serial = field_name_ds_4; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15473_01001~IGT_32_ch_comb_10_ch.xlsx'));

split_combo = string(strcat(field_name_tran_10, '_', field_name_ds_4)); 
config.combos.(split_combo).tran_serial = field_name_tran_10;
config.combos.(split_combo).ds_serial = field_name_ds_4; 
config.combos.(split_combo).char_data_path = fullfile(config.gen.charac_path, strcat(config.gen.axial_prof_name,  'IS_PCD15473_01002~IGT_32_ch_comb_10_ch.xlsx'));
